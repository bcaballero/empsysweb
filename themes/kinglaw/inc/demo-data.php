 ...
 * 
 */
function kinglaw_set_home_page(){
...
add_action('cms_import_finish', 'kinglaw_set_home_page');
 ...
 * 
 */
function kinglaw_set_menu_location(){
...
add_action('cms_import_finish', 'kinglaw_set_menu_location');