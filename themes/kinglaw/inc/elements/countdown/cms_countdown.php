...
if(class_exists('CmsShortCode')){
	vc_map(
		array(
			"name" => esc_html__("CMS Countdown", 'kinglaw'),
		    "base" => "cms_countdown",
		    ...
		    "params" => array(
		        array(
	            "type" => "textfield",
	            "heading" => esc_html__("Date count down", "kinglaw"),
	            "param_name" => "date_count_down",
	            "value" => "",
	            "description" => esc_html__("Set date count down (default:2020/10/10)", "kinglaw"),
	            "group" => esc_html__("General Settings", 'kinglaw')
		        ),
		    	array(
		            "type" => "cms_template",
