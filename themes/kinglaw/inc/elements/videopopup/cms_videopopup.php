...
vc_map(array(
    ...
    "params" => array(
        ...
        array(
            "type" => "dropdown",
            "class" => "",
            "heading" => esc_html__("Add Intro Video", 'kinglaw'),
            "admin_label" => true,
        ...
        array(
            "type" => "attach_image",
            "heading" => __ ( 'Video Intro', 'kinglaw' ),
        ...
        array(
            "type" => "textfield",
            "heading" => __ ( 'Intro Heiht', 'kinglaw' ),
        ...
        array(
            "type" => "colorpicker",
            "heading" => esc_html__("Overlay", 'kinglaw'),
            "param_name" => "overlay",
            "value" => "",
            "dependency" => array(
                "element"=>"intro_custom",
