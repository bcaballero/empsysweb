...
class CS_Recent_Post_Carousel extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                'cs_recent_post_carousel', esc_html__('CMS Recent Post style1', 'kinglaw'), array('description' => esc_html__('Recent Posts Widget.', 'kinglaw'),)
        );
    }
    ...
    function widget($args, $instance) {
        ...
        echo '<aside class="widget cms-recent-post-style1">';
            if($title) {
                                ...
                                <div class="cms-recent-media">  
                                   <div class="image">
                                        <?php if(has_post_thumbnail($post->ID)) {
                                            ...
                                            $thumbnail = wp_get_attachment_url( kinglaw_recnet_post_thumbnail() );
                                            $class = 'has-thumbnail';
                                        } else {
