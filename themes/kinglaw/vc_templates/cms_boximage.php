...
?>
<div id="<?php echo esc_attr($atts['html_id']);?>" class="cms-boximage cms-boximage-default">
    <?php if(!empty($image_url)) {?>
	<div class="cms-boximage-thumb">
		<img src="<?php echo esc_url($image_url); ?>" alt="<?php echo esc_attr($title); ?>" />
	</div>
    <?php }?>
    <h3 class="title" style="<?php echo wp_kses_post($inline_style);?> color:<?php echo esc_attr($title_color); ?>;font-size: <?php echo esc_attr($title_size); ?>; text-transform: <?php echo esc_attr($boximage_text_transform);?>">
