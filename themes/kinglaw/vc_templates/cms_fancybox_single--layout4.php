...
?>
<div class="cms-fancyboxes-wraper cms-fancyboxes-layout4 <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <div class="cms-fancybox-item">
        ...
        <div class="fancybox-content">
            ...
            <?php if($atts['description_item']): ?>
                <div class="fancybox-description" style="<?php echo wp_kses_post($inline_style);?> color:<?php echo esc_attr($decs_color); ?>;">
                    <?php echo apply_filters('the_content',$atts['description_item']);?>
                </div>
            <?php endif; ?>
            <?php if($atts['button_text']!=''):?>
                <div class="button-wrapper">
                    <a class="read-more" href="<?php echo esc_url($atts['button_link']);?>">
