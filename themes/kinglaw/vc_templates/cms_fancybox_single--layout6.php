<?php 
    ...
    $icon_color = isset($atts['icon_color']) ? $atts['icon_color'] : 'c29764';
...
?>
<div class="cms-fancyboxes-wraper cms-fancyboxes-layout6 <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <div class="cms-fancybox-item">
        ...
        <div class="fancybox-content">
            ...
            <div class="button-wrapper">
                <a class="read-more read-more-style1" href="<?php echo esc_url($atts['button_link']);?>"><?php echo esc_attr($atts['button_text']);?></a>
            </div>
            <?php endif;?>
        </div>
    </div>
