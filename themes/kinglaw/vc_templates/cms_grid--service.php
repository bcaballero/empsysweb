...
?>
<div class="cms-grid-wraper cms-grid-services1 <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <div class="row <?php echo esc_attr($atts['grid_class']);?>">
        <?php
        $posts = $atts['posts'];
        $size = 'kinglaw_blog_617x490';
                ...
                <div class="entry-services">
                    ...
                    <div class="entry-body">
                        ...
                        <div class="entry-excerpt">
                            <?php echo wp_trim_words(strip_tags(strip_shortcodes(get_the_content())),71); ?>
                        </div>
