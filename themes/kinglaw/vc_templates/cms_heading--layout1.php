...
<div id="<?php echo esc_attr($atts['html_id']);?>" class="cms-heading-wrapper cms-heading-layout1">
    <div class="cms-heading-content">
        <h3 class="title <?php echo esc_attr($heading1_style);?>" style="<?php echo wp_kses_post($inline_style);?> text-transform: <?php echo esc_attr($heading_text_transform);?>; font-size:<?php echo esc_attr($title_size);?>; color:<?php echo esc_attr($title_color); ?>; letter-spacing: <?php echo esc_attr($letter_spacing);?>">
